...
function JoinCommunityByToken(request, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield communityService_1.default.joinCommunityByToken(token, communityId);
            return {
                status: 200,
                jsonBody: response
            };
...
functions_1.app.http('JoinCommunityByToken', {
