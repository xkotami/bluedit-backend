...
exports.getCommunitiesByTokenUserId = getCommunitiesByTokenUserId;
const functions_1 = require("@azure/functions");
const communityService_1 = __importDefault(require("../service/communityService"));
function getCommunitiesByTokenUserId(request, context) {
...
functions_1.app.http('getCommunitiesByTokenUserId', {
