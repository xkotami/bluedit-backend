...
const upvote = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const comment = yield database_1.default.comment.update({
        where: {
            id: id
        },
        data: {
...
const downvote = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const comment = yield database_1.default.comment.update({
        where: {
            id: id
        },
